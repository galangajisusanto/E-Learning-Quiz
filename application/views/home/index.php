...
<head>
  ...
  <title>Code Studio|Online Course from Programer</title>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>home_assets/css/imagehover.min.css">
...
<body>
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo base_url() ?>">Code<span>Studio</span></a>
      </div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="#feature">Fasilitas</a></li>
        ...
        <div class="row">
          <div class="banner-text text-center">
            <div class="text-border">
              <h2 class="text-dec">Kepercayaan & Kualitas</h2>
            </div>
            <div class="intro-para text-center quote">
              <p class="big-text">Belajar Sekarang . . . Memimpin Kemudian.</p>
              <p class="small-text">Belajar Pemrograman Mudah dan Menyenangkan</p>
              <a href="#footer" class="btn get-quote">Dapatkan Info Menarik Seputar Pemrograman</a>
            </div>
    ...
    <div class="container">
      <div class="row">
        <div class="header-section text-center">
          <h2>Fasilitas</h2>
          <p>Kami Menyediakan Berbagai Fasilitas Belajar Pemrograman yang Gratis untuk Semua Member</p>
        ...
        <div class="feature-info">
          <div class="fea">
            <div class="col-md-4">
              <div class="heading pull-right">
                <h4>Materi dan Modul</h4>
                <p>Materi dan Modul Gratis dari Developer Profesional.</p>
              </div>
          ...
          <div class="fea">
            <div class="col-md-4">
              <div class="heading pull-right">
                <h4>Quiz Factory</h4>
                <p>Belajar Menyenangkan dan Ukur Pemahanmu dengan Quiz Factory.</p>
              </div>
              <div class="fea-img pull-left">
          ...
          <div class="fea">
            <div class="col-md-4">
              <div class="heading pull-right">
                ...
                <p>Berlomba Jadi yang Terbaik dengan Ranking System.</p>
              </div>
              <div class="fea-img pull-left">
          ...
          <div class="pm-staff-profile-container">
            <div class="pm-staff-profile-image-wrapper text-center">
              <div class="pm-staff-profile-image">
                <img src="<?php echo base_url(); ?>home_assets/img/mentor.jpg" alt="" class="img-thumbnail img-circle" />
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="<?php echo base_url(); ?>home_assets/img/course01.jpg" class="img-responsive">
            <figcaption>
              <h3>Course Name</h3>
        ...
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="<?php echo base_url(); ?>home_assets/img/course02.jpg" class="img-responsive">
            <figcaption>
              <h3>Course Name</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam atque, nostrum veniam consequatur libero fugiat, similique quis.</p>
            </figcaption>
        ...
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="<?php echo base_url(); ?>home_assets/img/course03.jpg" class="img-responsive">
            <figcaption>
              <h3>Course Name</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam atque, nostrum veniam consequatur libero fugiat, similique quis.</p>
            </figcaption>
        ...
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="<?php echo base_url(); ?>home_assets/img/course04.jpg" class="img-responsive">
            <figcaption>
              <h3>Course Name</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam atque, nostrum veniam consequatur libero fugiat, similique quis.</p>
            </figcaption>
        ...
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="<?php echo base_url(); ?>home_assets/img/course05.jpg" class="img-responsive">
            <figcaption>
              <h3>Course Name</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam atque, nostrum veniam consequatur libero fugiat, similique quis.</p>
            </figcaption>
        ...
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="<?php echo base_url(); ?>home_assets/img/course06.jpg" class="img-responsive">
            <figcaption>
              <h3>Course Name</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam atque, nostrum veniam consequatur libero fugiat, similique quis.</p>
            </figcaption>
 ...
 -->
  ...
  <section id="contact" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="header-section text-center">
          <h2>Contact Us</h2>
          <p>Apabila ada terdapat pertanyaan dapat disampaikan pada form di bawah ini</p>
          <hr class="bottom-line">
        </div>
  ...
  <script src="<?php echo base_url(); ?>home_assets/js/jquery.min.js"></script>
  <script src="<?php echo base_url(); ?>home_assets/js/jquery.easing.min.js"></script>
  <script src="<?php echo base_url(); ?>home_assets/js/bootstrap.min.js"></script>
  <script src="<?php echo base_url(); ?>home_assets/js/custom.js"></script>
  <script src="<?php echo base_url(); ?>home_assets/contactform/contactform.js"></script>
